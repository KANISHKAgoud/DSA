...
is, then the system displays the student details. Use sequential file to
main the data.*/
...
class tel  
{ public: 
 int rollNo,roll1;  char name[10];  char div;  char address[20];  void accept() 
 { 
  ...
  cout<<"\n\t"<<rollNo<<"\t\t"<<name<<"\t\t"<<div<<"\t\t"<<address; 
   ...
   int main() { 
 int i,n,ch,ch1,rec,start,count,add,n1,add2,start2,n2,y,a,b,on,oname,add3,start3,n3,y1,add4,start4,n4;  char name[20],name2[20];  tel t1; 
 count=0;  fstream g,f;  do 
 { 
