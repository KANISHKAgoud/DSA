/*To illustrate the various Binary Tree functions.
For given expression eg. a-b*c-d/e+f construct inorder sequence and traverse it using postorder
       ...
       cout<<op.top()->data<<"\t"; op.pop(); } 
          ...
          { New=new btree;
           ...
           { int i=1;
            ...
            if(i==2) cout<<node->data<<"\t";
             if(i==3) cout<<node->data<<"\n";
              if(i==4||i==5||i==6||i==7)
               cout<<node->data<<"\t";
                i++; 
                q.pop();
              if(node->left!=NULL)
               ...
               if(node->right!=NULL) q.push(node->right); 
                ...
                int main() 
              { 
                Tree tr; int ch; char ans; 
              do
               { cout<<"\n\tExpression Tree "; cout<<"\n\t1. Create\n\t2. Display\n\t3. Exit\n\t..... Enter Your Choice: "; 
               cin>>ch; switch(ch)
                { 
                    case 1:
                do { tr.create(); 
                ...
                break;
                 ...
                 case 2: cout<<"\n\t\t*****Display \n\t\t1. Recursive\n\t\t2. Non Recursive"; cout<<"\n\t\t....Enter Your Choice: "; 
                 cin>>ch;
                 
                  switch(ch)
                  { case 1: cout<<"\n\tRecursive Postorder Traversal\n"; tr.recursive(); break;
                  
                   case 2: cout<<"\n\tNon Recursive Postorder Traversal\n";tr.nonrecursive(); break; } break; 
